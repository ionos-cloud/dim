# If a reverse zone is referenced from multiple subnets
# it should be deleted after the last subnet has been deleted
...
$ ndcli modify pool testpol add subnet 10.18.0.0/25
INFO - Created subnet 10.18.0.0/25 in layer3domain default

$ ndcli create rr test.foo.bla. a 10.18.0.3
INFO - Marked IP 10.18.0.3 from layer3domain default as static
INFO - No zone found for test.foo.bla.
INFO - Creating RR 3 PTR test.foo.bla. in zone 0.18.10.in-addr.arpa
WARNING - No forward zone found. Only creating reverse entry.

$ ndcli modify pool testpol remove subnet 10.18.0.0/25 -c -f
INFO - Deleting RR 3 PTR test.foo.bla. from zone 0.18.10.in-addr.arpa
INFO - Freeing IP 10.18.0.3 from layer3domain default
